...
static char *SM_ErrorMsg[] = {
    ...
    (char *)"SM_CREATE_TABLE_SCAN_FAIL",                          // SM_CREATE_TABLE_SCAN_FAIL (START_SM_ERR - 10)
    ...
    (char *)"SM_GET_ALL_ATTR_INFO_FAIL",                          // SM_GET_ALL_ATTR_INFO_FAIL (START_SM_ERR - 38)
    (char *)"SM_GET_ALL_ATTR_INFO_SCAN_FAIL",                     // SM_GET_ALL_ATTR_INFO_SCAN_FAIL (START_SM_ERR - 39)
    (char *)"SM_GET_ALL_ATTR_INFO_SCAN_FAIL_CLOSE_SCAN_FAIL",     // SM_GET_ALL_ATTR_INFO_SCAN_FAIL_CLOSE_SCAN_FAIL (START_SM_ERR - 40)
    (char *)"SM_GET_ATTR_INFO_FAIL",                              // SM_GET_ATTR_INFO_FAIL (START_SM_ERR - 41)
    (char *)"SM_GET_ATTR_INFO_SCAN_FAIL",                         // SM_GET_ATTR_INFO_SCAN_FAIL (START_SM_ERR - 42)
    (char *)"SM_GET_ATTR_INFO_SCAN_FAIL_CLOSE_SCAN_FAIL",         // SM_GET_ATTR_INFO_SCAN_FAIL_CLOSE_SCAN_FAIL (START_SM_ERR - 43)
    (char *)"SM_GET_REL_INFO_FAIL",                               // SM_GET_REL_INFO_FAIL (START_SM_ERR - 41)
    (char *)"SM_GET_REL_INFO_SCAN_FAIL",                          // SM_GET_REL_INFO_SCAN_FAIL (START_SM_ERR - 42)
    (char *)"SM_GET_REL_INFO_SCAN_FAIL_CLOSE_SCAN_FAIL",          // SM_GET_REL_INFO_SCAN_FAIL_CLOSE_SCAN_FAIL (START_SM_ERR - 43)
    (char *)"Usage: set debug [TRUE | FALSE]",                    // SM_SET_DEBUG_INVALID (START_SM_ERR - 44)
};
