...
// 2019: Change the type of PageNum to make the code run in 64-bit mode
...
//
const int PF_PAGE_SIZE = 4096 - sizeof(int); // For deploy
// const int PF_PAGE_SIZE = 256 - sizeof(int); // For debug
